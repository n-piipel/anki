# Anki Flashcards - Spaced Repetition Learning

🧠 Одностраничное веб-приложение для изучения flashcards с использованием алгоритма интервальных повторений (Spaced Repetition).
...
Попробуйте приложение: [https://your-username.github.io/anki](https://your-username.github.io/anki)
